...
$(document).ready(function(){
	...
	$("#contenedor").append("<div id='pinterest'>"+ '<h4>'+ el.title +'</h4>'+ 
		'<p>'+ el.description +'</p>'+ '<p>'+ el.user +'</p>'+'<p>'+ el.hashtag +'</p>'
